...
<!-- Mirrored from demo.dashboardpack.com/architectui-html-pro/dashboards-crm.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 16 Dec 2021 08:19:15 GMT -->
<!-- Added by HTTrack -->
                        ...
                        <ul class="vertical-nav-menu">
                            ...
                            <li class="mm-active">
                                ...
                                <ul class="mm-show">
                                    ...
                                    {{-- <li>
                                        <a href="dashboards-crm.html" class="mm-active">
                            ...
                            <li>
                                <a href="#">
                                    <i class="metismenu-icon fas fa-box-open"></i>Products
                                    <i class="metismenu-state-icon"></i>
                                </a>
                                <ul>
                                    <li>
                                        <a href="{{route('products.create')}}">
                                            <i class="metismenu-icon"></i> Add Prodcuts
                                        </a>
                                    </li>
                                    <li>
                            ...
                            <li>
                                <a href="#">
                                    <i class="metismenu-icon fas fa-user-edit"></i>Roles
                                    <i class="metismenu-state-icon "></i>
                                </a>
                                <ul>
                                    <li>
                            ...
                            <li>
                                <a href="#">
                                    <i class="metismenu-icon fas fa-shopping-cart"></i> Orders
                                    <i class="metismenu-state-icon "></i>
                                </a>
                                <ul>
                                    <li>
                            ...
                            <li>
                                <a href="#">
                                    <i class="metismenu-icon fas fa-lock"></i> Secrets
                                    <i class="metismenu-state-icon "></i>
                                </a>
                                <ul>
                                    <li>
                            ...
                            <li>
                                <a href="#">
                                    <i class="metismenu-icon fas fa-comments-dollar"></i> Transcation
                                ...
                                <ul>
                                    <li>
                                        <a href="{{route('transcations.index')}}">
                                            {{-- <i class="metismenu-icon"> --}}</i>Manage Transcation
                                        </a>
                                    </li>
                                    {{-- <li>
...
<!-- Mirrored from demo.dashboardpack.com/architectui-html-pro/dashboards-crm.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 16 Dec 2021 08:19:17 GMT -->
